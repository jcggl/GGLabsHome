...
var _StoryRouter = require("./components/StoryRouter");
...
var withRouter = (0, _addons.makeDecorator)({
  name: "withRouter",
  ...
  wrapper: function wrapper(story, context, _ref) {
    ...
    return /*#__PURE__*/_react["default"].createElement(_StoryRouter.StoryRouter, {
